            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h2>LICENCIA</h2>
                        <p>coders free  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>
                        ...
                        <p>Coders free reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
                        <p>Estas terminos y condiciones se han generado en <a href="terminosycondicionesdeusoejemplo.com">terminosycondicionesdeusoejemplo.com</a>.</p>
                    </div>
                </div>
            </div>
        </div>
